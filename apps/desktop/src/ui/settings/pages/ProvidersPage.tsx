          ...
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              <Input
                ...
                aria-label={`${opts.providerDisplayName} ${credentialDisplayName}`}
              />
              <Button
                variant="outline"
                type="button"
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      void (async () => {
                        await setGlobalOpenAiProxyBaseUrl(openAiProxyBaseUrlInput.trim());
                        setSavingOpenAiProxyBaseUrl(false);
                      })();
                    }}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => {
                      setSavingOpenAiProxyBaseUrl(true);
                      void (async () => {
                        await setGlobalOpenAiProxyBaseUrl(null);
                        setSavingOpenAiProxyBaseUrl(false);
                      })();
                    }}
                  >
