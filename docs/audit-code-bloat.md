...
| **GRAND TOTAL** | **9,860** | **~5,250** | **~4,610** |

The archived TUI audited in an earlier version of this document has since been removed from the repo, so the remaining reduction opportunity here is the server/core surface.
