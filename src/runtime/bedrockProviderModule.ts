// @ts-nocheck
//
// Cowork-owned Bedrock provider override for pi-ai.
// This is adapted from the installed pi-ai Bedrock provider so we can pass
// per-request Bedrock auth config without mutating process-wide environment.
